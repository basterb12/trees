...
# Retrieve data
query <- "SELECT * FROM sensor.dist_15"
data <- dbGetQuery(con, query)

# data_path <- '/Users/sebastianherbst/Dissertation/Data processing/Output/Output - all_air_location_tree/2024-07-17_A2_5m_all_air_tree_data.csv'
# data <- read_csv(data_path)

# Extract 'd' from path_name
d <- 15#str_extract(path_name, "\\d+m")
